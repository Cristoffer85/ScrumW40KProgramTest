...
* Tillägg i användarKlassen är att: När säljaren gör en beställning/lägger till något ifrån databasen (En karaktär) finns en stor vertikal TV-skärm (Eller Hologramprojektor) på sidan som visar just den huvudkaraktärsklassen + faktionen i en “live-stance” när den står på skärmen. Som i en “rullande GIF- eller kortare video-sekvens". Detta hämtas ifrån en separat video i resourceKlass. 
